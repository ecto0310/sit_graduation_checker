...
const SelectSemester = ({ selected_semester, setSemester, startYear }: SelectSemesterProps) => {
    return (
        <>
            <Form.Select className='mb-1' value={selected_semester} onChange={e => setSemester(e.target.value)} >
