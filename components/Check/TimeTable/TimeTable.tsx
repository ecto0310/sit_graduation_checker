...
const TimeTable = ({ credits, setCredits, creditInfo, classes }: TimeTableProps) => {
    ...
    return (
        <>
            ...
            <ModalSelectClass modalShow={modalShow} setModalShow={setModalShow} classes={classes} semester={semester} day={day} time={time} credits={credits} setCredits={setCredits} creditInfo={creditInfo} />
        </>
    )
}
